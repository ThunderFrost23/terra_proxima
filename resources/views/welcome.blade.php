...
<div class="page">
    ...
    @forelse($news->sortByDesc('created_at')->take(6) as $newsItem)
        <div class="item">
            <div class="card">
                <div class="card__cover card__cover--one">
                    <img src="{{ asset('storage/' . $newsItem->image) }}" alt="news">
                </div>
                <div class="card__body">
                    <div class="card__title">{{ $newsItem->title }}</div>
                    <div class="card__desc">
                        <p>{{ strip_tags($newsItem->description) }}</p>
                    </div>
                </div>
            </div>
        </div>
    @empty
        <h2 class="nothing-msg">NOTHING TO SEE...</h2>
    @endforelse
</div>
            ...
            <div class="classes-hovered">
                <div class="classes-infos">
                    <p class="noselect">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptatum.
                        ...
                        Praesentium voluptate delectus sed reiciendis rem non modi quas necessitatibus deserunt earum
                        magni
                        nesciunt
    ...
    <div class="about">
        <div class="about-content">
            ...
            <p class="about-text">
                ...
                To showcase proficiency in game development, particularly using Unreal Engine 5, and to present a
                dynamic
                and engaging "Beat Them All" experience.

                <br><br>

                Developed by students as part of their year-end project for the Epitech school. The target audience
                includes
